...
a = 100;
Cap = 0.25;
Capn = 0.00001;% Capn = 0.001; %Capn = 1e-9; % Capn = 1e-12;
L = 0.2;
n = 6;
step = 200;
G = zeros(n,n);
...
dt_alt = 1/1000; %dt_alt = 1/100000; %dt_alt = 1/10;
...
%plot with Gaussian pulse input and varying In
for i = 1:length(time)
...
title('Fourier Transform of Gaussian pulse with noise')
ylabel('Amplitude of |V_5|')
xlabel('Frequency(Hz)')
